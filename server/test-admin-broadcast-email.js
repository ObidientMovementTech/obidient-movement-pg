...
Thank you for your continued dedication to the Obidient Movement.`,
    ...
    recipients: [
      { email: "spectamix@gmail.com", name: "Test User 1" },
      { email: "spectadev@gmail.com", name: "Test User 2" }
    ]
  };

  // 🚨 SAFETY CHECK: Ensure we're only using test emails
  const safeEmails = testData.recipients.every(recipient => 
    recipient.email.includes('spectamix@gmail.com') ||
    recipient.email.includes('spectadev@gmail.com')
  );
